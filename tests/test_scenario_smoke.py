...
async def test_full_scenario_smoke_lifecycle(db_session: AsyncSession, mock_bot):
    ...
    """
    # 0. Setup required channels in DB (@OfferRaider, @OfferMate, @MULTI_purpose_with_me_sale, @offerelite)
    for ch_name in ["@OfferRaider", "@OfferMate", "@MULTI_purpose_with_me_sale", "@offerelite"]:
